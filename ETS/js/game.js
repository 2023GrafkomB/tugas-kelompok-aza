...
function World() {
  ...
  function init() {
	...
	const texture = textureLoader.load('https://www.textures.com/system/gallery/photos/Roads/Roads/57027/Roads0113_1_350.jpg'); // Replace with the actual path to your texture image
	...
	const ground = createBox(3000, 20, 120000, groundMaterial, 0, -400, -60000);
	scene.add(ground);
