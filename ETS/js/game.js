...
function World() {
	...
	function init() {
		...
		const texture = textureLoader.load('./images.jpg'); // Replace with the actual path to your texture image
		// Calculate the repeat values based on the texture and geometry sizes
		const textureRepeatX = 3000 / 3050;
		const textureRepeatY = 120000 / 20000;
		...
		const ground = createBox(3000, 20, 112500, groundMaterial, 0, -400, -60000);
		scene.add(ground);
